...
function selectOption(start_button) {
...
function displayIntroCat() {
    var imageContainer = document.getElementById('intro-image-container');
    imageContainer.innerHTML = '';

    var introCat = new Image();
    introCat.src = 'cat.gif';
    introCat.alt = 'Cat';

    introCat.onload = function () {
        imageContainer.appendChild(introCat);
    };
}
...
function displayCat() {
    ...
    // Show Valentine image
    displayCatFlowers();
}

// Displays the flower cat on the Valentine page
function displayCatFlowers() {
    var imageContainer = document.getElementById('image-container');
    imageContainer.innerHTML = '';

    var catImage = new Image();
    catImage.src = 'cat_flower.gif';
    catImage.alt = 'Cat with flowers';
