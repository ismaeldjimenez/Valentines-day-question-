...
function selectOption(option) {
    ...
    if (option === 'yes') {
        ...
        flashRainbowColors(function() {
            ...
            displayCatHeart(); // Display the cat_kiss.gif
        });
    } else if (option === 'no') {
...
function displayCat() {
    ...
    catImage.src = 'cat_flower.gif'; // Assuming the cat image is named "cat.jpg"
...
function displayCatHeart() {
    ...
    catHeartImage.src = 'cat_kiss.gif'; // Assuming the cat_kiss image is named "cat_kiss.gif"
    // Set alternative text for the image (for accessibility)
